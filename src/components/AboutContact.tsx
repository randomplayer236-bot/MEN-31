...
export const WhatsAppButton = () => {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="fixed bottom-4 left-4 lg:bottom-6 lg:right-6 z-[100] bg-[#25D366] text-white p-3 lg:p-4 rounded-full shadow-[0_10px_30px_rgba(37,211,102,0.4)] hover:scale-110 active:scale-95 transition-all duration-300 flex items-center justify-center group"
