      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-3 gap-3 lg:gap-6">
          {featuredItems.map((item, index) => (
            <DraggableResizable key={item.id} id={`featured_item_${item.id}`}>
              <motion.div
  ...
  return (
    <footer className="bg-navy pt-12 pb-12 px-6 border-t border-ivory/5">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
        ...
        <DraggableResizable id="footer_col_1">
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-3xl font-bold tracking-[0.2em] text-ivory font-display">
        ...
        <DraggableResizable id="footer_col_2">
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
        ...
        <DraggableResizable id="footer_col_3">
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
      ...
      <DraggableResizable id="footer_copyright">
